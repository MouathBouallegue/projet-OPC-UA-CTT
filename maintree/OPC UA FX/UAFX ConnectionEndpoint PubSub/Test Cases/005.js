...
function Test_005( connectionEndpoint ) {
    ...
    if( isDefined( connectionEndpoint ) ) {
        ...
        if( TestConnectionEndpoints.length > 0 ) {
            ...
            if( !suppressMessages ) addSkipped( "Could not find a FunctionalEntity exposing only InputData or only OutputData variables or failed to create the ConnectionEndpoint. Skipping test." );
